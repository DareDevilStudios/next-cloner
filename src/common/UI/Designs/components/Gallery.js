  ...
  const gallery = [
    {
      ...
      desc: "D'LEAP is a classic example of quality designs from ShipTech-ICON which exhibits best performance in speed, aesthetics and luxury. D'LEAP is an electric yatch whch contribute so sustainability as well. The nterior is designed with maximum comfort and utmost luxury to the passesngers.",
      length: "15.50m",
      width: "4.10m",
      depth: "1.8m",
      approx_draft: "0.9m",
      station_spacing: "0.5m",
      passenger_capacity: "50+4",
