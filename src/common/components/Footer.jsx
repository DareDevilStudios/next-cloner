...
const Footer = () => {
    ...
    return (
        <div className="w-full bg-shipblue text-white">
            <div className="top flex justify-around gap-7 px-14 py-5">
                <div className="part1 flex flex-col justify-around h-full">
                    <Image className="w-48 my-4"
                        src={Logo}
                        alt="logo"/>
                    <div className="details my-4">
                        <div className="d1 flex gap-3 my-2">
                            <svg className="w-6 h-6 text-shipy" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <div className="d1 flex gap-3 my-2">
                            ...
                            <p className="w-48">87148 04425</p>
                        </div>
                        <div className="d1 flex gap-3 my-2">
                            <svg className="w-6 h-6 text-shipy" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <p className="w-48">info@shiptech-icon.com</p>
                        </div>
                    </div>
                    <div className="flex gap-5">
                        <div className="w-12 h-12 bg-black bg-opacity-50 hover:bg-shipy duration-500 rounded-full flex justify-center items-center p-3">
                            <Image className="w-9 text-white"
                                src={fb}
                                alt="fb"/>
                        </div>
                        <div className="w-12 h-12 bg-black bg-opacity-50 hover:bg-shipy duration-500 rounded-full flex justify-center items-center p-3">
                ...
                <div className="part2">
                    <h1 className="underline underline-offset-[.7rem] mt-4 mb-7 text-2xl">
                        Who We Are
                    </h1>
                ...
                <div className="part3 flex flex-col items-center">
                    <h1 className="underline underline-offset-[.7rem] mt-4 mb-7 text-2xl self-start">
                        Our Gallery
                    </h1>
            ...
            <div class="sm:flex sm:items-center sm:justify-around py-8">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">
                    Copyright ©2023
                    <span className='text-shipy'>ShipTech-ICON</span>. All Rights Reserved.
                </span>
